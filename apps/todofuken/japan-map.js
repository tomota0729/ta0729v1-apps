...
//       Wikipedia「日本地図.svg」をベースに Geolonia が作成
// ライセンス: GFDL (GNU Free Documentation License)
//
// 各都道府県は <g data-code="1"〜"47"> で識別でき、game.js の PREFS.id と一致する。
// ラベル無しの白地図。<title>（県名ツールチップ）は game.js 側で除去してクイズ性を保つ。

const JAPAN_MAP_SVG = `<svg id="prefMap" class="geolonia-svg-map" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
